...
const comparisonCards = [
  {
    ...
    toneClassName: 'border-[#ff6b8a]/22 bg-[#391221]',
    bulletWrapClassName: 'bg-[#ff6b8a]/16 text-[#ff9ab0]',
    items: comparisonWithout,
    icon: '×',
  },
  {
    title: 'Con Cuysite',
    toneClassName: 'border-emerald-400/16 bg-[#0e2c21]',
    bulletWrapClassName: 'bg-emerald-400/14 text-emerald-300',
...
export function BenefitsPage() {
  ...
  return (
    <>
      <section className="relative -mt-24 overflow-hidden border-b border-white/8 px-6 pb-12 pt-14 text-white md:pb-14 lg:-mt-28 lg:px-8 lg:pt-18" style={{ background: darkPageBackground }}>
        <div
        ...
        <div className="container-shell relative z-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(24rem,34rem)] lg:items-start">
            <MotionStagger className="max-w-2xl lg:translate-y-44">
              <MotionStaggerItem>
                <p className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/6 px-4 py-2 text-sm font-semibold text-white/78">
                  Beneficios principales
                </p>
              </MotionStaggerItem>
              <MotionStaggerItem>
                <h1 className="mt-6 max-w-xl text-[2.7rem] font-semibold leading-[1.02] tracking-[-0.03em] text-white sm:text-[3.6rem] lg:text-[4.5rem]">
              ...
              <MotionStaggerItem>
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <ButtonLink to="/precios" variant="ghost" className="!border-white/12 !bg-white/6 !text-white">
                    Ver precios
                  </ButtonLink>
                </div>
              </MotionStaggerItem>
            ...
            <MotionReveal>
              <div className="relative mx-auto -mt-6 w-full max-w-[34rem] lg:-mt-10">
                {heroBadges.map((badge) => (
                  <div
                    key={badge.label}
                    className={`absolute inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/7 px-4 py-2.5 text-sm font-semibold text-white/82 shadow-[0_0_26px_rgba(168,155,255,0.22)] backdrop-blur-md ${badge.className}`}
                  >
                    <span className={`flex h-6 w-6 items-center justify-center rounded-full ${badge.iconWrapClassName ?? 'bg-white/8'}`}>
                ...
                <div
                  className="absolute inset-x-6 bottom-10 top-16 rounded-full blur-3xl"
      ...
      <section className="border-b border-white/8 px-6 py-12 lg:px-8" style={{ background: darkPageBackground }}>
              ...
              <MotionStaggerItem key={title}>
                <MotionHover className="h-full">
                  <article className="feature-card-dark h-full rounded-[1.5rem] p-6">
                    <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/6 text-[var(--secondary-light)]">
      ...
      <section className="border-b border-white/8 px-6 py-14 lg:px-8" style={{ background: darkPageBackground }}>
        <div className="container-shell">
          <MotionReveal>
            <h2 className="text-center text-3xl font-semibold text-white">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[0.78fr_1.44fr_0.78fr] lg:items-center">
            <MotionReveal>
              <div className="relative mx-auto w-full max-w-[18rem] lg:max-w-[19rem]">
                <div className="absolute inset-x-3 bottom-3 top-10 rounded-full blur-3xl" style={{ background: 'radial-gradient(circle, rgba(168,155,255,0.28) 0%, rgba(255,255,255,0) 74%)' }} aria-hidden="true" />
            ...
            <MotionStagger className="grid gap-5 md:grid-cols-[1fr_auto_1fr] md:items-stretch">
              <MotionStaggerItem>
                <div className={`rounded-[1.9rem] border p-7 text-white/86 shadow-[0_20px_50px_rgba(0,0,0,0.22)] ${comparisonCards[0].toneClassName}`}>
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="text-xl font-semibold text-white">{comparisonCards[0].title}</h3>
              ...
              <MotionStaggerItem>
                <div className="mx-auto flex h-full items-center justify-center">
                  <span className="inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/12 bg-white/7 text-lg font-semibold text-white">
                    VS
                  </span>
                </div>
              </MotionStaggerItem>
              <MotionStaggerItem>
                <div className={`rounded-[1.9rem] border p-7 text-white/86 shadow-[0_20px_50px_rgba(0,0,0,0.22)] ${comparisonCards[1].toneClassName}`}>
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="text-xl font-semibold text-white">{comparisonCards[1].title}</h3>
          ...
          <div className="grid gap-5 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <MotionReveal>
              <div className="feature-card-dark overflow-hidden rounded-[1.75rem] p-0">
                <div className="relative flex min-h-[20rem] items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(168,155,255,0.22),rgba(5,11,30,0.18)_55%,rgba(5,11,30,0)_82%)] px-6 py-8">
                  <div className="w-full max-w-[18rem] rounded-[2rem] border border-white/10 bg-[#0d1738]/86 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.32)]">
                    <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-[0.16em] text-white/58">
                      <span>Actividad</span>
                    ...
                    <div className="mt-5 grid gap-3">
                      {[
                        ...
                        <div key={item} className="flex items-center gap-3 rounded-[1rem] border border-white/8 bg-white/6 px-4 py-3 text-sm text-white/82">
                    ...
                    <div className="mt-5 rounded-[1rem] border border-white/8 bg-white/6 px-4 py-3 text-sm text-white/64">
            ...
            <MotionStagger className="grid gap-3">
              {[
                ...
                <MotionStaggerItem key={label}>
                  <div className="group flex items-center gap-4 rounded-2xl border border-white/[0.06] bg-white/[0.03] px-5 py-4 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.3)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/[0.15] hover:bg-white/[0.06] hover:shadow-[0_16px_48px_-8px_rgba(91,46,255,0.12),0_8px_32px_-8px_rgba(0,0,0,0.3)]">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/[0.06] text-[var(--secondary-light)] ring-1 ring-white/[0.06] transition-all duration-300 group-hover:bg-white/[0.1] group-hover:ring-white/[0.12]">
                      <Icon className="h-5 w-5" />
                    </span>
                    <span className="text-sm font-medium text-white/80 transition-colors duration-300 group-hover:text-white/90">{label}</span>
                  </div>
                </MotionStaggerItem>
              ))}
            </MotionStagger>
        ...
        <div className="container-shell">
          ...
          <MotionStagger className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {includes.map(({ icon: Icon, label }) => (
              <MotionStaggerItem key={label}>
                <div className="feature-card-dark flex h-full items-center gap-3 rounded-[1.25rem] p-4 text-sm font-medium text-white/82">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/6 text-[var(--secondary-light)]">
                    <Icon className="h-5 w-5" />
                  </span>
                  {label}
                </div>
            ...
            {allTech.map((item) => (
              <MotionStaggerItem key={item.title}>
                <div className="feature-card-dark flex items-center gap-3 rounded-[1.2rem] p-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white/7">
                    {item.iconUrl ? <img src={item.iconUrl} alt={item.name} className="h-6 w-6 object-contain" loading="lazy" /> : null}
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-white">{item.title}</p>
                    <p className="mt-1 text-xs text-white/56">{item.name}</p>
                  </div>
                </div>
              </MotionStaggerItem>
            ))}
            ...
            {stats.map((item) => (
              <MotionStaggerItem key={item.label}>
                <div className="feature-card-dark rounded-[1.3rem] p-5 text-center">
                  ...
                  <p className="mt-3 text-sm text-white/64">{item.label}</p>
                </div>
              </MotionStaggerItem>
            ))}
          </MotionStagger>
      ...
      <section className="border-b border-white/8 px-6 py-10 lg:px-8" style={{ background: '#040812' }}>
        <div className="container-shell">
          <MotionReveal>
            ...
            <MotionStagger className="grid gap-4">
              {faqItems.slice(0, 3).map((item, index) => (
                <MotionStaggerItem key={item.question}>
                  <details className="group rounded-[1.25rem] border border-white/8 bg-white/[0.03] p-4 transition hover:border-white/16">
                    <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-left">
                      <div className="flex items-center gap-3">
                        <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/8 text-[11px] font-semibold text-[var(--secondary-light)]">
                          {index + 1}
                        </span>
                        <span className="text-sm font-semibold text-white sm:text-base">{item.question}</span>
                      </div>
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/8 text-sm font-semibold text-white/70 transition duration-200 group-open:rotate-45">
                        +
                      </span>
                    </summary>
                    <div className="faq-content">
                      <div className="overflow-hidden">
                        <div className="mt-3 border-t border-white/8 pt-3">
                          <p className="max-w-3xl text-sm leading-6 text-white/60">{item.answer}</p>
                        </div>
                      </div>
                    </div>
                  </details>
